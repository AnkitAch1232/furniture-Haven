<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Furniture_haven.Admin.Dashboard" %>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <h4> <% if(Session["category"] != null) { Response.Write(Session["category"]); } else { Response.Write("0"); } %> </h4>
                                    <div>
