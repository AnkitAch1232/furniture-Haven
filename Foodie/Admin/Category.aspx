<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Furniture_haven.Admin.Category" %>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-reponsive">
                                                    <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand"
                                                        ...
                                                        <HeaderTemplate>
                                                            <table class="table table-responsive-sm data-table-export table-hover nowrap">
                                                                <thead>
                                                                    <tr>
