<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Furniture_haven.Admin.Product" %>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-reponsive">
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand"
                                                        ...
                                                        <HeaderTemplate>
                                                            <table class="table data-table-export table-responsive-sm table-hover nowrap">
                                                                <thead>
                                                                    <tr>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img alt="" width="40" src="<%# Utils.GetImageUrl( Eval("ImageUr1")) %>" />
                                                                </td>
