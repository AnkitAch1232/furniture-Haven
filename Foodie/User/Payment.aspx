<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Furniture_haven.User.Payment" %>
                        ...
                        <div class="card-header">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    ...
                                    <p class="text-muted">
                                        Note: At the start of recieving your order, you need to do full payment. 
