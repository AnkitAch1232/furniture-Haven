<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Furniture_haven.User.Cart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="book_section layout_padding">
        ...
        <div class="container">
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCart_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                <HeaderTemplate>
                    <table>
                        <thead>
                            <tr class="table table-responsive-sm">
                                <th>Name</th>
                                <th>Image</th>
                                <th>Unit Price</th>
                                <th>Quantity</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <img width="60" src="<%# Utils.GetImageUrl(Eval("ImageUr1")) %>" alt="" />
                        </td>
                        <td>Rs
                                ...
                                <div class="quantity">
                                    <div class="pro-qty">
                                        ...
                                        <asp:RegularExpressionValidator ID="revQuantity" runat="server" ErrorMessage="*" ForeColor="Red"
                                            Font-Size="Small" ValidationExpression="^[1-9][0-9]*$" ControlToValidate="txtQuantity"
                ...
                <FooterTemplate>
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Menu.aspx" class="btn btn-info"><i class="fa-arrow-circle-left mr-2"></i>Continue Shopping</a>
                        </td>
                        <td>
